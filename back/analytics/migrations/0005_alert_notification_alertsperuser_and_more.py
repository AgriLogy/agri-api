        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="A brief title for the alert.", max_length=200
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Soil humidity percentage.",
                        max_digits=5,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        help_text="Ideal time period for irrigation.", max_length=100
                    ),
                ),
                (
                    "last_irrigation_date",
                    models.DateField(help_text="Date of the last irrigation."),
                ),
                (
                    "last_start_irrigation_hour",
                    models.TimeField(help_text="Start time of the last irrigation."),
                ),
                (
                    "last_finish_irrigation_hour",
                    models.TimeField(help_text="Finish time of the last irrigation."),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_read",
                    models.BooleanField(
                        default=False, help_text="Whether the user has read this alert"
                    ),
                ),
